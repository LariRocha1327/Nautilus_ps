...
class Time:
    ...
    def __add__(self,time2):
        s =self.pontos + time2.pontos
        return s

    def __sub__(self,time2):
        d =self.pontos - time2.pontos
        return d

time_A=Time("Brasil", 20, 7, 10, 11, 7)
time_B=Time("Japao", 27, 7, 13, 9, 5)
time_C=Time("Canada", 15, 7, 6, 13, 11)
...
times = []
times.append(Time("Brasil", 20, 7, 10, 11, 7))
